    ...
    <div class="py-12">
        ...
        <form method="POST" action="{{ route('events.update',  ['event' => $event->id]) }}">
            ...
            <div class="mt-4">
                ...
                <x-textarea row="3" id="information" name="information" class="block mt-1 w-ful">{{ $event->information }}</x-textarea>
            </div>
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="start_time" class="block mt-1 w-full" type="text" value="{{ $startTime }}" name="start_time" required/>
            </div>
            <div class="mt-4">
                <x-jet-label for="end_time" value="終了時間" />
                <x-jet-input id="end_time" class="block mt-1 w-full" type="text" value="{{ $endTime }}" name="end_time" required/>
            </div>
        </div>
